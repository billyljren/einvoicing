...
trait PeriodTrait {
    ...
    protected $periodDescription = null;
    ...
    /**
     * Get period end date
     * @return string|null Period end date
     */
    ...
    /**
     * Set period end date
     * @param  string|null $periodDescription Period end date
     * @return self                         This instance
     */
    public function setPeriodDescription(?string $periodDescription): self {
