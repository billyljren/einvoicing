...
// This is a modified version of UXML/UXML. Refer to dependency for original codes, this version is modified to fit our use. The original code is no longer used, the dependency is maintained for reference.
class UXML {
