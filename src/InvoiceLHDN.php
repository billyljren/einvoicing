...
class InvoiceLHDN extends Invoice {
     ...
     * buyer.
     */
    const TYPE_COMMERCIAL_INVOICE = 01;
     ...
     * Refund note
     * 
     * Document/message for providing refund information to the relevant party.
     */
    const TYPE_REFUND_NOTE = 04;

    const TYPE_INVOICE_SELFBILL = 11;

    const TYPE_CREDIT_NOTE_SELFBILL = 12;

    const TYPE_DEBIT_NOTE_SELFBILL = 13;

    const TYPE_REFUND_NOTE_SELFBILL = 14;
    ...
    public function setForexRate(float $amount){
